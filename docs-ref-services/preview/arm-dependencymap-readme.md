---
title: Azure DependencyMap client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/arm-dependencymap, dependencymap
ms.date: 02/19/2026
ms.topic: reference
ms.devlang: javascript
ms.service: dependencymap
---
# Azure DependencyMap client library for JavaScript - version 1.0.0-alpha.20260219.1 
