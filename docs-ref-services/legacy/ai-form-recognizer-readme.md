...
keywords: Azure, javascript, SDK, API, @azure/ai-form-recognizer, forms-recognizer
author: ramya-rao-a
ms.author: ramyar
ms.date: 08/20/2020
ms.topic: reference
...
Install the Azure Form Recognizer client library for JavaScript - version 3.0.0 
 with `npm`:
