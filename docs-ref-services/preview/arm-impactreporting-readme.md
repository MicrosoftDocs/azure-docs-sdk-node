---
title: Azure Impact client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/arm-impactreporting, impactreporting
ms.date: 02/23/2026
ms.topic: reference
ms.devlang: javascript
ms.service: impactreporting
---
# Azure Impact client library for JavaScript - version 1.0.0-alpha.20260223.1 
