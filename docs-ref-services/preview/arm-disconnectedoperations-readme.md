---
title: Azure DisconnectedOperationsManagement client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/arm-disconnectedoperations, disconnectedoperations
ms.date: 03/06/2026
ms.topic: reference
ms.devlang: javascript
ms.service: disconnectedoperations
---
# Azure DisconnectedOperationsManagement client library for JavaScript - version 1.0.0-beta.1 
...
- [Source code](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-disconnectedoperations_1.0.0-beta.1/sdk/disconnectedoperations/arm-disconnectedoperations)
...
- [Samples](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-disconnectedoperations_1.0.0-beta.1/sdk/disconnectedoperations/arm-disconnectedoperations/samples)
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-disconnectedoperations_1.0.0-beta.1/SUPPORT.md) for more details.
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-disconnectedoperations_1.0.0-beta.1/sdk/core/logger).

## Next steps

Please take a look at the [samples](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-disconnectedoperations_1.0.0-beta.1/sdk/disconnectedoperations/arm-disconnectedoperations/samples) directory for detailed examples on how to use this library.

## Contributing

If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-disconnectedoperations_1.0.0-beta.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[azure_identity]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-disconnectedoperations_1.0.0-beta.1/sdk/identity/identity
[defaultazurecredential]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-disconnectedoperations_1.0.0-beta.1/sdk/identity/identity#defaultazurecredential
