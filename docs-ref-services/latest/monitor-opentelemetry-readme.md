...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-opentelemetry_1.0.0/SUPPORT.md) for more details.
...
| ------------------------------- |------------------------------------------------------------------------------------------------------------|-------|
| azureMonitorExporterConfig                     | Azure Monitor OpenTelemetry Exporter Configuration. [More info here](https://github.com/Azure/azure-sdk-for-js/tree/@azure/monitor-opentelemetry_1.0.0/sdk/monitor/monitor-opentelemetry-exporter)                                                | |
...
### Distributed Tracing
  ...
  - [Azure SDK](https://github.com/Azure/azure-sdk-for-js/tree/@azure/monitor-opentelemetry_1.0.0/sdk/instrumentation/opentelemetry-instrumentation-azure-sdk)
...
For complete samples of a few champion scenarios, see the [`samples/`](https://github.com/Azure/azure-sdk-for-js/tree/@azure/monitor-opentelemetry_1.0.0/sdk/monitor/monitor-opentelemetry/samples-dev/) folder.
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-opentelemetry_1.0.0/CONTRIBUTING.md) to learn more about how to build and test the code.
