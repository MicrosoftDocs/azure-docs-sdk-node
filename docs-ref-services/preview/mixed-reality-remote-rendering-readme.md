---
title: Azure Remote Rendering client library for JavaScript - version 1.0.0-beta.1 
keywords: Azure, javascript, SDK, API, @azure/mixed-reality-remote-rendering, remote-rendering
author: ramya-rao-a
ms.author: ramyar
ms.date: 09/21/2021
ms.topic: reference
