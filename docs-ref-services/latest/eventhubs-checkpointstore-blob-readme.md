...
keywords: Azure, javascript, SDK, API, @azure/eventhubs-checkpointstore-blob, eventhubs
author: maggiepint
ms.author: magpint
ms.date: 07/15/2021
ms.topic: article
...
# Azure Event Hubs Checkpoint Store client library for JavaScript - Version dev 
