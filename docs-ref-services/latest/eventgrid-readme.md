...
# Azure Event Grid client library for JavaScript - Version 4.1.0 
...
[Source code](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid_4.1.0/sdk/eventgrid/eventgrid/) |
...
[Samples](https://github.com/Azure/azure-sdk-for-js/tree/@azure/eventgrid_4.1.0/sdk/eventgrid/eventgrid/samples)
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/eventgrid_4.1.0/sdk/core/logger).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid_4.1.0/CONTRIBUTING.md) to learn more about how to build and test the code.
