...
ms.service: monitor
---
# Azure Monitor Query Metrics client library for JavaScript - version 1.0.0 
...
Checkout the [Migration Guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/sdk/monitor/monitor-query-metrics/MIGRATION.md) for detailed instructions on how to update your application code from the original `@azure/monitor-query` package to the `@azure/monitor-query-metrics` library.
...
For more information, see our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/SUPPORT.md).
...
An authenticated client is required to query Metrics. To authenticate, the following example uses [DefaultAzureCredential](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/sdk/identity/identity/README.md#defaultazurecredential) from the [@azure/identity](https://www.npmjs.com/package/@azure/identity) package.
...
To diagnose various failure scenarios, see the [troubleshooting guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/sdk/monitor/monitor-query-metrics/TROUBLESHOOTING.md).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/CONTRIBUTING.md) to learn more about how to build and test the code.
...
For more details, view our [tests](https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/sdk/monitor/monitor-query-metrics/test) folder.
...
[changelog]: https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/sdk/monitor/monitor-query-metrics/CHANGELOG.md
...
[samples]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/monitor-query-metrics_1.0.0/sdk/monitor/monitor-query-metrics/samples
[source]: https://github.com/Azure/azure-sdk-for-js/blob/@azure/monitor-query-metrics_1.0.0/sdk/monitor/monitor-query-metrics/
