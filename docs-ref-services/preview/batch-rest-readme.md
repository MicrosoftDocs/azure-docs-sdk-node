...
ms.service: batch
---
# Azure Batch REST client library for JavaScript - version 1.0.0-alpha.20241213.1 


Azure Batch provides Cloud-scale job scheduling and compute management.

**Please rely heavily on our [REST client docs](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/batch_1.0.0-alpha.20241213.1/documentation/rest-clients.md) to use this library**
...
To use an [Microsoft Entra ID token credential](https://github.com/Azure/azure-sdk-for-js/blob/@azure-rest/batch_1.0.0-alpha.20241213.1/sdk/identity/identity/samples/AzureIdentityExamples.md#authenticating-with-a-pre-fetched-access-token),
provide an instance of the desired credential type obtained from the
[@azure/identity](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/batch_1.0.0-alpha.20241213.1/sdk/identity/identity#credentials) library.
...
After setup, you can choose which type of [credential](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/batch_1.0.0-alpha.20241213.1/sdk/identity/identity#credentials) from `@azure/identity` to use.
As an example, [DefaultAzureCredential](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/batch_1.0.0-alpha.20241213.1/sdk/identity/identity#defaultazurecredential)
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure-rest/batch_1.0.0-alpha.20241213.1/sdk/core/logger).
