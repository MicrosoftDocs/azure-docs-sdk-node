...
---
# Azure VoiceLive client library for JavaScript - version 1.0.0 
...
> - **Node.js (ESM):** [`samples/telemetry/`](https://github.com/Azure/azure-sdk-for-js/blob/@azure/ai-voicelive_1.0.0/sdk/voicelive/ai-voicelive/samples/telemetry/README.md) — console exporter and Azure Monitor variant.
> - **Browser (Vite):** [`samples/telemetry-browser/`](https://github.com/Azure/azure-sdk-for-js/blob/@azure/ai-voicelive_1.0.0/sdk/voicelive/ai-voicelive/samples/telemetry-browser/README.md) — in-page span viewer.
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/ai-voicelive_1.0.0/sdk/core/logger).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/ai-voicelive_1.0.0/CONTRIBUTING.md) to learn more about how to build and test the code.
