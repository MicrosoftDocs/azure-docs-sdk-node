---
title: Azure Synapse Monitoring client library for JavaScript - version 1.0.0-beta.2 
keywords: Azure, javascript, SDK, API, @azure/synapse-monitoring, synapse-analytics-monitoring
author: ramya-rao-a
ms.author: ramyar
ms.date: 02/09/2021
ms.topic: reference
