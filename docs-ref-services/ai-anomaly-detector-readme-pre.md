...
The `AnomalyDetectorClient` provides the below methods for anomaly detection:
...
- An existing Cognitive Services or Anomaly Detector resource. If you need to create the resource, you can use the Azure Portal or Azure CLI.
