...
Learn more about [Azure Service Bus](/azure/service-bus-messaging/service-bus-messaging-overview).
...
See the documentation for this package [here](/javascript/api/overview/azure/arm-servicebus-readme?view=azure-node-latest).
...
See the documentation for this package [here](/javascript/api/@azure/service-bus/?view=azure-node-latest).

For more code samples that use the @azure/service-bus package, explore the [JavaScript samples](/samples/browse/?languages=javascript&products=azure-service-bus).
