...
# Azure Communication Common client library for JavaScript - Version 1.0.0 
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/communication-common_1.0.0/CONTRIBUTING.md) to learn more about how to build and test the code.
