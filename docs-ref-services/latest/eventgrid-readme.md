...
---
# Azure Event Grid client library for JavaScript - version 5.3.0 
...
- [Source code](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid_5.3.0/sdk/eventgrid/eventgrid/)
...
- [Samples](https://github.com/Azure/azure-sdk-for-js/tree/@azure/eventgrid_5.3.0/sdk/eventgrid/eventgrid/samples)
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid_5.3.0/SUPPORT.md) for more details.
...
With the `@azure/identity` package, you can seamlessly authorize requests in both development and production environments. To learn more about Azure Active Directory, see the [`@azure/identity` README](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid_5.3.0/sdk/identity/identity/README.md).
...
For more detailed instructions on how to enable the logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/eventgrid_5.3.0/sdk/core/logger).
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/eventgrid_5.3.0/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[azure-core-tracing-github]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/eventgrid_5.3.0/sdk/core/core-tracing
