...
keywords: Azure, javascript, SDK, API, formrecognizer, @azure/ai-form-recognizer, 
author: maggiepint
ms.author: magpint
ms.date: 06/10/2020
ms.topic: article
...
# Azure Form Recognizer client library for JavaScript - Version 1.0.0-preview.3 
...
Install the Azure Form Recognizer client library for JavaScript - Version 1.0.0-preview.3 
 with `npm`:
