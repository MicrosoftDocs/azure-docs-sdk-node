...
ms.service: iot
---
# Azure IoT Models Repository client library for JavaScript - version 1.0.0-alpha.20241227.1 
...
- [Source code](https://github.com/Azure/azure-sdk-for-js/tree/@azure/iot-modelsrepository_1.0.0-alpha.20241227.1/sdk/iot/iot-modelsrepository)
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/iot-modelsrepository_1.0.0-alpha.20241227.1/SUPPORT.md) for more details.
