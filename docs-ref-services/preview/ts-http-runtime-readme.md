...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@typespec/ts-http-runtime_0.2.3/SUPPORT.md) for more details.
...
Most policies only concern themselves with either the request or the response, but there are some exceptions such as the [LogPolicy](https://github.com/Azure/azure-sdk-for-js/blob/@typespec/ts-http-runtime_0.2.3/sdk/core/ts-http-runtime/src/policies/logPolicy.ts) which logs information from each.
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@typespec/ts-http-runtime_0.2.3/CONTRIBUTING.md) to learn more about how to build and test the code.
