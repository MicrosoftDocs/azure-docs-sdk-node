...
ms.service: core
---
# Azure Core XML client library for JavaScript - version 1.4.4 
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/core-xml_1.4.4/SUPPORT.md) for more details.
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/core-xml_1.4.4/CONTRIBUTING.md) to learn more about how to build and test the code.
