...
# Azure Storage File Share client library for JavaScript - Version 12.9.0-beta.2 
...
Key links:
- [Source code](https://github.com/Azure/azure-sdk-for-js/tree/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/storage-file-share)
...
- [Samples](https://github.com/Azure/azure-sdk-for-js/tree/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/storage-file-share/samples)
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/storage-file-share_12.9.0-beta.2/SUPPORT.md) for more details.
...
For a complete sample on iterating please see [samples/typescript/src/iterators-files-and-directories.ts](https://github.com/Azure/azure-sdk-for-js/blob/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/storage-file-share/samples/typescript/src/iterators-files-and-directories.ts).
...
A complete example of basic scenarios is at [samples/typescript/src/basic.ts](https://github.com/Azure/azure-sdk-for-js/blob/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/storage-file-share/samples/typescript/src/basic.ts).
...
- [File Share Storage Samples (JavaScript)](https://github.com/Azure/azure-sdk-for-js/tree/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/storage-file-share/samples/javascript)
- [File Share Storage Samples (TypeScript)](https://github.com/Azure/azure-sdk-for-js/tree/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/storage-file-share/samples/typescript)
- [File Share Storage Test Cases](https://github.com/Azure/azure-sdk-for-js/tree/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/storage-file-share/test)

## Contributing

If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/storage-file-share_12.9.0-beta.2/CONTRIBUTING.md) to learn more about how to build and test the code.

Also refer to [Storage specific guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/storage-file-share_12.9.0-beta.2/sdk/storage/CONTRIBUTING.md) for additional information on setting up the test environment for storage libraries.
