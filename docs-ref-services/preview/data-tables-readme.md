...
# Azure Tables client library for JavaScript - Version 12.0.0-beta.1 
...
If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/data-tables_12.0.0-beta.1/CONTRIBUTING.md) to learn more about how to build and test the code.
