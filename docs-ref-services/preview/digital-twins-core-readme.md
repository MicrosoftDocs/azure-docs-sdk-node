---
title: Azure Digital Twins Core client library for JavaScript - version 1.1.0-beta.1 
...
---
# Azure Digital Twins Core client library for JavaScript - version 1.1.0-beta.1 
