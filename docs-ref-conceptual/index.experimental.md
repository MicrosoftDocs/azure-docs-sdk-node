				...
				<div style="margin-top: 75px;">
					...
					<ul class="cardsM cols cols2">
						<li style="
							...
							">
							<a class="card" href="https://vscode-ppe.azurewebsites.net/tryappservice/">
								<br>
									<div class="cardText">
									<h3 style="
										font-size: large;
						...
						<li style="
								...
								margin-left: 10px;
							">
							<a class="card" href="https://review.docs.microsoft.com/en-us/javascript/azure/index-preview?view=azure-node-latest&branch=pr-en-us-354">
								<br>
									<div class="cardText">
									<h3 style="
										color: black;
