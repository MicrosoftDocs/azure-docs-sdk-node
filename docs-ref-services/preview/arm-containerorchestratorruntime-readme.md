...
---
# Azure KubernetesRuntime client library for JavaScript - version 1.0.0-alpha.20241217.1 
...
See our [support policy](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-containerorchestratorruntime_1.0.0-alpha.20241217.1/SUPPORT.md) for more details.
...
For more detailed instructions on how to enable logs, you can look at the [@azure/logger package docs](https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-containerorchestratorruntime_1.0.0-alpha.20241217.1/sdk/core/logger).


## Contributing

If you'd like to contribute to this library, please read the [contributing guide](https://github.com/Azure/azure-sdk-for-js/blob/@azure/arm-containerorchestratorruntime_1.0.0-alpha.20241217.1/CONTRIBUTING.md) to learn more about how to build and test the code.
...
[azure_identity]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-containerorchestratorruntime_1.0.0-alpha.20241217.1/sdk/identity/identity
[defaultazurecredential]: https://github.com/Azure/azure-sdk-for-js/tree/@azure/arm-containerorchestratorruntime_1.0.0-alpha.20241217.1/sdk/identity/identity#defaultazurecredential
