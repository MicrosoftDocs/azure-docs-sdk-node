---
title: Azure Device Registry software update client library for JavaScript
keywords: Azure, javascript, SDK, API, @azure/iot-device-registry-software-update, deviceregistry
ms.date: 09/05/2026
ms.topic: reference
ms.devlang: javascript
ms.service: deviceregistry
---
# Azure Device Registry software update client library for JavaScript - version 1.0.0-alpha.20260905.1 
